...
<div class="page-wrapper">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
                    <div class="my-auto mb-2">
                        <h2 class="mb-1">All Vendor Credits</h2>
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">All Vendor Credits</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                        ...
                        <div class="ActionHeadButtons">
                            ...
                            <a href="new-vendor-credits.php"  class="btn btn-primary d-flex align-items-center themeBtn"><iconify-icon icon="majesticons:plus"></iconify-icon> New Vendor Credits</a>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-single select2">
                                    <option value="s-0" disabled selected>Reference No</option>
                                    <option value="us">#RF1101</option>
                                    <option value="ca">#RF1102</option>
                                    <option value="ca">#RF1103</option>
                                    <option value="gb">#RF1104</option>
                                    <option value="au">#RF1105</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <!-- <label for="#">Product</label> -->
                                <select class="js-example-basic-single select2">
                                    <option value="s-0" disabled selected>Vendor Name</option>
                                    <option value="us">John Doe</option>
                                    <option value="ca">Jane Smith</option>
                                    <option value="ca">John Doe</option>
                                    <option value="gb">Emily Clark</option>
                                    <option value="au">Michael Brown</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-single select2">
                                    ...
                                    <option value="us">Pending Approval</option>
                                    <option value="ca">Open</option>
                                    <option value="ma">In Transit</option>
                                    <option value="co">Closed</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-3">
                    ...
                    <div class="custom-datatable-filter">
                        <table class="table common-datatable withoutActionTR nowrap w-100">
                            ...
                            <td>2025-01-01 10:00</td>
                                ...
                                <td>John Doe</td>
                                <td>#RF56757</td>
                                <td><span class="badge bg-soft-secondary">In Transit</span></td>
                                <td>$1200</td>
                                <td>$400</td>
                                <td>
                                    <div class="d-flex align-items-center ActionDropdown">
                                    <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover"
                                            data-bs-toggle="tooltip" data-placement="top" title="vendor-credits-view" href="vendor-credits-view.php">
                                            <span class="icon">
                            ...
                            <td>2025-01-02 11:00</td>
                                ...
                                <td>Jane Smith</td>
                                <td>#RF89897</td>
                                <td><span class="badge bg-soft-success">Open</span></td>
                                <td>$100</td>
                                <td>NA</td>
                                <td>
                                    <div class="d-flex align-items-center ActionDropdown">
                            ...
                            <td>2025-01-03 14:30</td>
                                ...
                                <td>John Doe</td>
                                <td>#RF10434</td>
                                <td><span class="badge bg-soft-info">Closed</span></td>
                                <td>$300</td>
                                <td>$300</td>
                                <td>
                                    <div class="d-flex align-items-center ActionDropdown">
                            ...
                            <td>2025-01-04 09:45</td>
                                ...
                                <td>Emily Clark</td>
                                <td>#RF56757</td>
                                <td><span class="badge bg-soft-secondary">Pending Approval</span></td>
                                <td>$400</td>
                                <td>NA</td>
                                <td>
                                    <div class="d-flex align-items-center ActionDropdown">
