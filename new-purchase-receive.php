...
<div class="page-wrapper">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
                    <div class="my-auto mb-2">
                        <h2 class="mb-1"> New Purchase Receive</h2>
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item">
                                <a href="purchase-received.php">All Purchase Receives</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">New Purchase Receive</li>
                            </ol>
                        </nav>
                    </div>
                            ...
                            <div class="ItemNewContainer">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                    <div class="row align-items-center">
                                                        <div class="col-lg-3">
                                                            <label for="#" >Purchase Receive# <span>*</span></label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <div class="skuCode">
                                            ...
                                            <div class="form-group">
                                                    <div class="row align-items-center">
                                                        <div class="col-lg-3">
                                                            <label for="#" >Received Date <span>*</span></label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <div class="skuCode">
