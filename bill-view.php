    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb salesOrderHeader">
                    <div class="my-auto mb-2">
                        ...
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item">
                                <a href="purchase-orders.php">New Bill</a>
                                </li>
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                        ...
                        <div class="ActionHeadButtons ">
                            ...
                            <a href="edit-bill.php" class="btn EditBtn"> Edit <iconify-icon icon="akar-icons:edit"></iconify-icon></a>
                            ...
                            <a href="javascript:void(0);" class="btn btnImport" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"><iconify-icon icon="line-md:circle-twotone-to-confirm-circle-transition"></iconify-icon>Record Payment</a>
                            ...
                            <div id="SalesOrderInvoice" style="max-width: 850px; margin: 20px auto; border: 1px solid #ddd; padding: 20px; border-radius: 8px;">
                                    ...
                                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                                        ...
                                        <div style="text-align: right;">
                                            ...
                                            <p style="margin: 5px 0; font-size: 14px;"><strong>Bill Date:</strong> 17/06/2023</p>
...
<div class="offcanvas offcanvas-end MangePaymentOffcanvas" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header">
        <h5 id="offcanvasRightLabel">Record Payment #00002</h5>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group">
                                                    <div class="row align-items-center">
                                                        <div class="col-lg-4">
                                                            <label for="#">Payment Made <span>*</span></label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" placeholder=" " id="name" value="" class="form-control">
                                                        </div>
                                                    </div>
    ...
    <div class="offcanvas-footer">
        <div class="actionManagePayment">
            ...
            <a href="#" class="btn btn-primary">Record Payment</a>
