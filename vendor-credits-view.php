...
<div class="page-wrapper">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb salesOrderHeader">
                    <div class="my-auto mb-2">
                        <h2 class="mb-1">Vendor Credits View</h2>
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item">
                                <a href="purchase-orders.php">New Vendor Credits</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">Vendor Credits View</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                        ...
                        <div class="ActionHeadButtons ">
                            ...
                            <a href="vendor-credits.php" class="btn btnImport"><iconify-icon icon="typcn:arrow-back-outline"></iconify-icon> Back</a>
                            <a href="edit-vendor-credits.php" class="btn EditBtn"> Edit <iconify-icon icon="akar-icons:edit"></iconify-icon></a>
                            ...
                            <div id="SalesOrderInvoice" style="max-width: 850px; margin: 20px auto; border: 1px solid #ddd; padding: 20px; border-radius: 8px;">
                                    ...
                                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                                        <div>
                                            ...
                                            <p style="margin: 5px 0; font-size: 16px;"><strong>Credit Note# <span style="color:#ff5c00">CN-00002</span></strong> </p>
                                        </div>
                                        <div style="text-align: right;">
                                            <h3 style="margin: 0;">Vendor Credits</h3>
                                            <p style="margin: 5px 0; font-size: 14px;"><strong>Vendor Credit Date:</strong> 17/06/2023</p>
