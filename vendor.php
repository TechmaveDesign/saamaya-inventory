    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                        ...
                        <div class="ActionHeadButtons">
                            ...
                            <a href="vendor-add.php"  class="btn btn-primary d-flex align-items-center themeBtn"><iconify-icon icon="majesticons:plus"></iconify-icon> New Vendors</a>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-single select2">
                                    <option value="s-0" disabled selected>Select Vendor</option>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <!-- <label for="#">Product</label> -->
                                <select class="js-example-basic-single select2">
                                    <option value="s-0" disabled selected>Select Company</option>
                                    <option value="us">Fresh Farm Co.</option>
                                    <option value="ca">Basic B Burgers</option>
                                    <option value="ca">Food Mania Restaurant</option>
                                    <option value="gb">Urban Solutions</option>
                                    <option value="au">Alpha Tech</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <!-- <label for="#">Product</label> -->
                                <select class="js-example-basic-single select2">
                                    <option value="s-0" disabled selected>Vendor Type</option>
                                    <option value="us">Individuals</option>
                                    <option value="ca">Business</option>
                                    <option value="ma">Manufacturer</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover"
                                            data-bs-toggle="tooltip" data-placement="top" title="Customer Detail" href="vendor-view.php">
                                            <span class="icon">
