...
<div class="page-wrapper">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
                    <div class="my-auto mb-2">
                        <h2 class="mb-1">Edit Payment Made</h2>
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item">
                                <a href="#">Payments Made View</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">Edit Payment Made</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                        ...
                        <div class="ActionHeadButtons">
                            <a href="payments-made-view.php" class="btn btnImport"><iconify-icon icon="typcn:arrow-back-outline"></iconify-icon> Back</a>
                ...
                <div class="ItemContainerTop  mb-3">
                        <div class="row">
                                <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row align-items-center">
                                                            <div class="col-lg-3">
                                                                <label for="#">Vendor Name <span>*</span></label>
                                                            </div>
                                                            <div class="col-lg-8">
