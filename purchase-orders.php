    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                        ...
                        <div class="ActionHeadButtons">
                            ...
                            <a href="new-purchase-order.php"  class="btn btn-primary d-flex align-items-center themeBtn"><iconify-icon icon="majesticons:plus"></iconify-icon> New Purchase Order</a>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-single select2">
                                    ...
                                    <option value="us">#CUS1101</option>
                                    <option value="ca">#CUS1102</option>
                                    <option value="ca">#CUS1103</option>
                                    <option value="gb">#CUS1104</option>
                                    <option value="au">#CUS1105</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-3">
                    ...
                    <div class="custom-datatable-filter">
                        <table class="table common-datatable withoutActionTR nowrap w-100">
                            ...
                            <td>2025-01-01 10:00</td>
                                ...
                                <td>John Doe</td>
                                <td>12454</td>
                                <td>2025-01-02 12:00</td>
                                <td>$1200</td>
                                <td><span class="badge bg-soft-secondary">Draft</span></td>
                                <td>
