...
<div class="page-wrapper">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
                    <div class="my-auto mb-2">
                        <h2 class="mb-1">Payments Made</h2>
                        <nav>
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                        ...
                        <div class="ActionHeadButtons">
                            <a href="all-payments.php" class="btn btnImport"><iconify-icon icon="typcn:arrow-back-outline"></iconify-icon> Back</a>
                ...
                <div class="topActionHeader TopHeadEnquiry">
                                    ...
                                    <ul class="nav nav-tabs TabsStyle1" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <iconify-icon icon="arcticons:advance-auto-parts" width="18" height="18"></iconify-icon>
                                            Vendor Advance
                                            </a>
                                        </li>
