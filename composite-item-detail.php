...
<div class="page-wrapper">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
                    <div class="my-auto mb-2">
                        <h2 class="mb-1">Composite Item Details</h2>
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Composite Item Details</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                        ...
                        <div class="ActionHeadButtons">
                            ...
                            <a href="composite-item-edit.php" class="btn EditBtn"> Edit <iconify-icon icon="akar-icons:edit"></iconify-icon></a>
                                                                        ...
                                                                        <tbody>
                                                                                ...
                                                                                <td>
                                                                                    <div class="d-flex align-items-center file-name-icon">
                                                                                        <a href="#" class="avatar avatar-md avatar-rounded">
                                                                                            <img src="assets/img/new-image/91nBm7ilp9L.png" class="img-fluid" alt="Stephan Peralt">
                                                                                        </a>
                                                                                        <div class="ms-2">
                                                                                            <h6 class="fw-medium"><a href="#">Aashirvaad Atta</a></h6>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                                <td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div class="d-flex align-items-center file-name-icon">
                                                                                        <a href="#" class="avatar avatar-md avatar-rounded">
                                                                                            <img src="assets/img/new-image/riceImg.png" class="img-fluid" alt="Stephan Peralt">
                                                                                        </a>
                                                                                        <div class="ms-2">
                                                                                            <h6 class="fw-medium"><a href="#">Dawaat Rice</a></h6>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                                <td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div class="d-flex align-items-center file-name-icon">
                                                                                        <a href="#" class="avatar avatar-md avatar-rounded">
                                                                                            <img src="assets/img/new-image/910-refined-1-pouch-soyabean-oil.png" class="img-fluid" alt="Stephan Peralt">
                                                                                        </a>
                                                                                        <div class="ms-2">
                                                                                            <h6 class="fw-medium"><a href="#">Fortune soyabean oil</a></h6>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                                <td>
