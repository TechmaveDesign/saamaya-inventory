...
<div class="page-wrapper">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
                    <div class="my-auto mb-2">
                        <h2 class="mb-1">Edit Composite Item</h2>
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Edit Composite Item</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                        ...
                        <div class="ActionHeadButtons">
                            <a href="composite-item-detail.php" class="btn btnImport"><iconify-icon icon="typcn:arrow-back-outline"></iconify-icon> Back</a>
                                                   ...
                                                   <thead>
                                                        ...
                                                        <tbody>
                                                            <tr class="varrientDetailRow">
                                                                <td>
                                                                    <img src="assets/img/new-image/91nBm7ilp9L.png" alt="" class="ItemImg">
                                                                </td>
                                                                <td class="SearchInputTd">
                                                                
                                                                    <div class="profile__input profile__input1">
                                                                        <input type="text" class="input__location"
                                                                            placeholder="Search and select an item" aria-expanded="false" value="Aashirvaad Atta 5kg">
                                                                ...
                                                                <td class="QtyInput">
                                                                 ...
                                                                 <p class="PricePerUnit">$140.00  per unit</p>
                                                                </td>
                                                                <td>
                                                                160.00
                                                                </td>
                                                            ...
                                                            <tr class="varrientDetailRow">
                                                                <td>
                                                                    <img src="assets/img/new-image/riceImg.png" alt="" class="ItemImg">
                                                                </td>
                                                                <td class="SearchInputTd">
                                                                
                                                                    <div class="profile__input profile__input1">
                                                                        <input type="text" class="input__location"
                                                                            placeholder="Search and select an item" aria-expanded="false" value="Dawaat Rice 15kg">
                                                                        <ul class="dropdown-menu">
                                                                            <!-- <iconify-icon icon="bxs:up-arrow" style="color: white"
                                                                                class="arrowupIcon"></iconify-icon> -->
                                                                            <div class="locationList_container">
                                                                ...
                                                                <td class="QtyInput">
                                                                 <input type="text" placeholder="" id="name" class="form-control" value="1">
                                                                 <p class="PricePerUnit">$60.00 per unit</p>
                                                                </td>
                                                                <td>
                                                                  180.00
                                                                </td>
                                                            ...
                                                            <tr class="varrientDetailRow">
                                                                <td>
                                                                    <img src="assets/img/new-image/910-refined-1-pouch-soyabean-oil.png" alt="" class="ItemImg">
                                                                </td>
                                                                <td class="SearchInputTd">
                                                                
                                                                    <div class="profile__input profile__input1">
                                                                        <input type="text" class="input__location"
                                                                            placeholder="Search and select an item" aria-expanded="false" value="Fortune soyabean oil 1 Ltr">
                                                                        <ul class="dropdown-menu">
                                                                            <!-- <iconify-icon icon="bxs:up-arrow" style="color: white"
                                                                                class="arrowupIcon"></iconify-icon> -->
                                                                            <div class="locationList_container">
             ...
             <div class="FormSubmit_fix_container">
                                <a href="composite-item-detail.php">
...
<script>
    ...
    const defaultImages = [
        'assets/img/new-image/image.png',
        'assets/img/new-image/pansari-super-saver-grocery-comb.png',
