...
<div class="page-wrapper">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
                    <div class="my-auto mb-2">
                        <h2 class="mb-1">New Vendor Credits</h2>
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item">
                                <a href="purchase-orders.php">Vendor Credits</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">New Vendor Credits</li>
                            </ol>
                        </nav>
                    </div>
             ...
             <div class="ItemContainerTop">
                    <div class="row">
                            ...
                            <div class="ItemNewContainer1">
                                        <div class="row">
                                            <div class="col-lg-6">
                                            <h6 class="SectionTitleFG">Vendor Credits Details</h6>
