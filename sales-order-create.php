    ...
    <div class="content">
        <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
            <div class="my-auto mb-2">
                <h2 class="mb-1">New Sales Order</h2>
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="sales-order-list.php">Sales Orders List</a>
                        </li>
            ...
            <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                ...
                <div class="ActionHeadButtons">
                    <a href="sales-order-list.php" class="btn btnImport">
                            ...
                            <div class="col-lg-8">
                                <div class="InputFelidsContainer">
                                    ...
                                    <div class="form-group">
                                        <div class="row align-items-center">
                                            <div class="col-lg-3">
                                                <label for="#">Sales Order# <span>*</span></label>
                                            </div>
                                            <div class="col-lg-8">
                                                <input type="text" placeholder=" " id="name" class="form-control">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row align-items-center">
                                            <div class="col-lg-3">
                                                <label for="#">Sales Order Date <span>*</span></label>
                                            </div>
                                            <div class="col-lg-8">
                                                <div class="skuCode">
...
-------------------------------------- -->
    ...
    <script>
                ...
                profileInputs.forEach(profileInput => {
                    ...
                    locationItems.forEach(item => {
                        item.addEventListener('click', function (e) {
                            e.preventDefault();
                            locationItems.forEach(item => item.classList.remove(
                                'active'));
                            this.classList.add('active');
                            input.value = this.querySelector('.ItemName').textContent
                                .trim();
        ...
        <tr class="varrientDetailRow">
           ...
           <td class="QtyInput">
            <input type="text" placeholder="1.00" id="name" class="form-control" value="">
            </td>
            <td class="QtyInput">
