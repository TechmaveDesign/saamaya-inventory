...
<div class="page-wrapper">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
                    <div class="my-auto mb-2">
                        <h2 class="mb-1">Inventory Adjustment</h2>
                        <nav>
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                        ...
                        <div class="ActionHeadButtons">
                            ...
                            <a href="inventory-adjustment.php"  class="btn btn-primary d-flex align-items-center themeBtn"><iconify-icon icon="majesticons:plus"></iconify-icon> New Adjust</a>
                        </div>
                    ...
                    <div class="custom-datatable-filter">
                        <table class="table common-datatable withoutActionTR nowrap w-100">
                            ...
                            <tr>
                                ...
                                <td>Adjustment due to damaged items</td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center ActionDropdown">
                                        <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover"
                                            data-bs-toggle="tooltip" data-placement="top" title="Adjustment Detail" href="inventory-adjustment-view.php">
                                            <span class="icon">
                            ...
                            <tr>
                                ...
                                <td>Corrected incorrect stock count</td>
                                <td><span class="badge bg-soft-success">Adjusted</span></td>
                                <td>INV-67890</td>
                                <td>Quantity</td>
                                <td>Jane Smith</td>
                            ...
                            <tr>
                                ...
                                <td>Discrepancy resolved during audit</td>
                                <td><span class="badge bg-soft-success">Adjusted</span></td>
                                <td>INV-34567</td>
                                <td>Quantity</td>
                                <td>Admin</td>
                            ...
                            <tr>
                                ...
                                <td>Inventory mismatch adjustment</td>
                                <td><span class="badge bg-soft-success">Adjusted</span></td>
                                <td>INV-45678</td>
                                <td>Value</td>
                                <td>Emily Davis</td>
                            ...
                            <tr>
                                ...
                                <td>Additional stock from supplier</td>
                                <td><span class="badge bg-soft-success">Adjusted</span></td>
                                <td>INV-56789</td>
                                <td>Quantity</td>
                                <td>Michael Brown</td>
                            ...
                            <tr>
                                ...
                                <td>Corrected stock mismatch</td>
                                <td><span class="badge bg-soft-success">Adjusted</span></td>
                                <td>INV-78901</td>
                                <td>Quantity</td>
                                <td>John Doe</td>
