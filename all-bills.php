    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                        ...
                        <div class="ActionHeadButtons">
                            ...
                            <a href="new-bill.php"  class="btn btn-primary d-flex align-items-center themeBtn"><iconify-icon icon="majesticons:plus"></iconify-icon> New Bills</a>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-single select2">
                                    <option value="s-0" disabled selected>Bill No</option>
                                    <option value="us">#1101</option>
                                    <option value="ca">#1102</option>
                                    <option value="ca">#1103</option>
                                    <option value="gb">#1104</option>
                                    <option value="au">#1105</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-3">
                    ...
                    <div class="custom-datatable-filter">
                        <table class="table common-datatable withoutActionTR nowrap w-100">
                            ...
                            <td>2025-01-01 10:00</td>
                                ...
                                <td>$1200</td>
                                <td>$200</td>
                                <td><span class="badge alert-danger">Overdue by 4 days</span></td>
                                <td>
                                    <div class="d-flex align-items-center ActionDropdown">
                                    <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover"
                                            data-bs-toggle="tooltip" data-placement="top" title="bill-view" href="bill-view.php">
                                            <span class="icon">
