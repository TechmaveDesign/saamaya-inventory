    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                        ...
                        <div class="ActionHeadButtons">
                            ...
                            <a href="payments-made.php"  class="btn btn-primary d-flex align-items-center themeBtn"><iconify-icon icon="majesticons:plus"></iconify-icon> New Payments</a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <!-- <label for="#">Product</label> -->
                                <select class="js-example-basic-single select2">
                                    <option value="s-0" disabled selected>Mode</option>
                                    <option value="us">Cash</option>
                                    <option value="ca">Cheque</option>
                                    <option value="ma">Credit Card</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            ...
                            <td>2025-01-01 10:00</td>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover"
                                            data-bs-toggle="tooltip" data-placement="top" title="payments-made-view" href="payments-made-view.php">
                                            <span class="icon">
