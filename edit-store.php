    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                        ...
                        <div class="ActionHeadButtons">
                            <a href="store.php" class="btn btnImport"><iconify-icon icon="typcn:arrow-back-outline"></iconify-icon> Back</a>
                                                            ...
                                                            <div class="tab-content">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="row">
                                                                                <div class="col-lg-2">
                                                                                    <label class="flexlabels_tracture">Opening Hours</label>
                                                                                </div>
                                                                                <div class="col-lg-5">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input type="text" class="form-control time__pickers" id="" vlaue="" placeholder="">
                                                                                        </div>
                                                                                        </div>
