...
<div class="page-wrapper">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
                    <div class="my-auto mb-2">
                        <h2 class="mb-1">New Warehouse</h2>
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">New Warehouse</li>
                            </ol>
                        </nav>
                    </div>
                                            ...
                                            <div class="form-group">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="CustomerKop">
                                                            <div class="emailBox">
                                                            <input type="text" placeholder="Phone No. " id="name" class="form-control">
                                                            <iconify-icon icon="mingcute:phone-line" class="IconInput"></iconify-icon>
                                                            </div>
                                                            <div class="emailBox">
                                                            <input type="text" placeholder="Mobile No. " id="name" class="form-control">
                                                            <iconify-icon icon="meteor-icons:mobile" class="IconInput"></iconify-icon>
                                                            </div>
                                                            ...
                                                            <div class="tab-content">
                                                                    <div class="tab-pane active mt-3" id="homeIcon" aria-labelledby="homeIcon-tab" role="tabpanel">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="row align-items-center">
                                                                                <div class="col-lg-2">
                                                                                    <label for="#">Capacity (in tons) </label>
                                                                                </div>
                                                                                <div class="col-lg-5">
                                                                                    <div class="skuCode">
                                                                                        <input type="text" placeholder="" id="name" class="form-control">
