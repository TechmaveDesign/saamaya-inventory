...
<div class="page-wrapper">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
                    <div class="my-auto mb-2">
                        <h2 class="mb-1">Return Sale Order</h2>
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item">
                                <a href="return-sale-order.php">Return Sale Order List</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">Return Sale Order</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                        ...
                        <div class="ActionHeadButtons">
                            <a href="return-sale-order.php" class="btn btnImport"><iconify-icon icon="typcn:arrow-back-outline"></iconify-icon> Back</a>
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="form-group">
                                                    <div class="row align-items-center">
                                                        <div class="col-lg-3">
                                                            <label for="#">Sale Order No. <span>*</span></label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                        <div class="skuCode">
                            ...
                            <div class="ItemNewContainer">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                    <div class="row align-items-center">
                                                        <div class="col-lg-3">
                                                            <label for="#" >RMA# <span>*</span></label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <div class="skuCode">
                                                            <input type="text" placeholder=" " id="name" class="form-control" value="RMA0001">
                                            ...
                                            <div class="col-lg-12">
                                            <div class="paymentManage mt-0 infoMessage">
                                                <div class="messageContainerPay">
                                                    <!-- <h6> WHAT'S NEXT?</h6> -->
                                                    <p class="messagePP" id="ScanItemBtn"><iconify-icon icon="fluent:info-16-filled"></iconify-icon> You can also select or scan the items to be included from the sale order. <a href="#" class="scanBtn">Select or Scan items</a> </p>
                                                    <p class="messagePP" id="ManuallyItemBtn"><iconify-icon icon="fluent:info-16-filled"></iconify-icon> You can also add all items from the package and manually adjust their quantities. <a href="#" class="scanBtn"> Add Manually</a> </p>
                                                    
                                                </div>
                                            </div>
                                            <div class="sectionBox ComboItemsbox mt-3">
                                            ...
                                            <div class="col-lg-12 tableBox VariantContainer mb-3" id="manuallyItemTable">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td style="width:100px">
                                                                 <input type="text" placeholder="" id="name" class="form-control" value="10">
                                                             ...
                                                             <tr>
                                                                ...
                                                                <td style="width:100px">
                                                                 <input type="text" placeholder="" id="name" class="form-control" value="18">
                                            ...
                                            <div class="col-lg-12 tableBox VariantContainer mb-3" id="scanItemTable" >
                                                   ...
                                                   <thead>
                                                        ...
                                                        <tbody>
                                                            <tr class="varrientDetailRow">
                                                                ...
                                                                <td class="QtyInput">
                                                                <input type="text" placeholder="0" id="name" class="form-control" value="">
...
<script>
    $(document).ready(function(){
        $('#ManuallyItemBtn').hide();
        $('#scanItemTable').hide();

        $('#ScanItemBtn').click(function(){
            $('#manuallyItemTable').hide();
            $('#ScanItemBtn').hide();
            $('#scanItemTable').show();
            $('#ManuallyItemBtn').show();
        })
        $('#ManuallyItemBtn').click(function(){
            $('#manuallyItemTable').show();
            $('#ScanItemBtn').show();
            $('#scanItemTable').hide();
            $('#ManuallyItemBtn').hide();
        })
