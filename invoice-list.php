    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                        ...
                        <div class="ActionHeadButtons">
                            ...
                            <a href="invoice-create.php"  class="btn btn-primary d-flex align-items-center themeBtn"><iconify-icon icon="majesticons:plus"></iconify-icon> New Invoice</a>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-single select2">
                                    ...
                                    <option value="ca">Invoiced</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="custom-datatable-filter">
                        <table class="table common-datatable withoutActionTR nowrap w-100">
                            ...
                            <tr>
                                ...
                                <td>987654321</td>
                                <td>Sarah Lee</td>
                                <td><span class="badge bg-soft-danger">Unpaid</span></td>
                                <td>2025-02-03</td>
                                <td>$300</td>
                                <td>$250</td>
                                <td>
