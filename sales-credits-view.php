...
<div class="page-wrapper">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb salesOrderHeader">
                    <div class="my-auto mb-2">
                        <h2 class="mb-1">Sales Credits View</h2>
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item">
                                <a href="new-sales-credits.php">New Sales Credits</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">Sales Credits View</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                        ...
                        <div class="ActionHeadButtons ">
                            ...
                            <a href="sales-credit.php" class="btn btnImport"><iconify-icon icon="typcn:arrow-back-outline"></iconify-icon> Back</a>
                            <a href="edit-sales-credits.php" class="btn EditBtn"> Edit <iconify-icon icon="akar-icons:edit"></iconify-icon></a>
                            ...
                            <a href="javascript:void(0);" class="btn btnImport" data-bs-toggle="modal" data-bs-target="#scanModal"><iconify-icon icon="ant-design:file-pdf-outlined"></iconify-icon>Apply to Invoices</a>
                            ...
                            <div id="SalesOrderInvoice" style="max-width: 850px; margin: 20px auto; border: 1px solid #ddd; padding: 20px; border-radius: 8px;">
                                    ...
                                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                                        <div>
                                            ...
                                            <p style="margin: 5px 0; font-size: 16px;"><strong>Credit Note# <span style="color:#ff5c00">SO-00002</span></strong> </p>
                                        </div>
                                        <div style="text-align: right;">
                                            <h3 style="margin: 0;">Sales Credits</h3>
                                            <p style="margin: 5px 0; font-size: 14px;"><strong>Sales Credit Date:</strong> 17/06/2023</p>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="scanModalLabel">Apply Credits to Invoices <strong> #CN00002</strong></h5>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header">
        <h5 id="offcanvasRightLabel">Manage Payment <strong>#00002</strong></h5>
    ...
    <div class="ItemContainerTop">
                ...
                <div class="ItemNewContainer1">
                            <div class="row">
                                <div class="col-lg-12">
                                <h6 class="SectionTitleFG">Balance <strong> $300</strong></h6>
